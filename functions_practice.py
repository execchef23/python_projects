...
# A function named pack() that accepts three arguments, and return a single list with the three arguments inside a list elements.
...
# (the first element of the list), and "Next I eat __" (for the following elements in the list). If the list is empty, print "My lunchbox is empty!".
